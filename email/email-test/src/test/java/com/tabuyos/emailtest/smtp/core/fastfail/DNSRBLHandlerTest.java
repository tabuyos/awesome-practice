...
package com.tabuyos.emailtest.smtp.core.fastfail;

import com.google.common.base.Preconditions;
import com.tabuyos.emailtest.smtp.utils.BaseFakeSMTPSession;
...
public class DNSRBLHandlerTest {
    ...
    return new DNSRBLHandler() {
      ...
      protected boolean resolve(String host) {
        ...
        throw new UnsupportedOperationException(
            "getByName(" + host + ") not implemented in DNSRBLHandlerTest mock");
      }
  ...
  void testBlackListedTextPresent() throws Exception {
    ...
    assertThat(mockedSMTPSession.getAttachment(RBL_DETAIL_MAIL_ATTRIBUTE_NAME, Connection))
        .describedAs("Details")
        .contains("Blocked - see http://www.spamcop.net/bl.shtml?127.0.0.2");
    assertThat(mockedSMTPSession.getAttachment(RBL_BLOCKLISTED_MAIL_ATTRIBUTE_NAME, Connection))
        .withFailMessage("Blocked")
        .isPresent();
  }
