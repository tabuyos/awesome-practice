...
public class SpamTrapHandlerTest {
  ...
  void testSpamTrap() throws Exception {
    ...
    HookReturnCode result =
        handler
            .doRcpt(
                setUpSMTPSession(ip), MaybeSender.nullSender(), new MailAddress(SPAM_TRAP_RECIP1))
            .getResult();
    ...
    result =
        handler
            .doRcpt(setUpSMTPSession(ip), MaybeSender.nullSender(), new MailAddress(RECIP1))
            .getResult();
    ...
    result =
        handler
            .doRcpt(setUpSMTPSession(ip2), MaybeSender.nullSender(), new MailAddress(RECIP1))
            .getResult();
    ...
    assertThat(result)
        .describedAs("Not blocked. BlockTime exceeded")
        .isEqualTo(HookReturnCode.declined());
  }
}
