 ...
 * under the License.                                           *
 ****************************************************************/
package com.tabuyos.emailtest.smtp;

import com.google.common.io.CharStreams;
import com.tabuyos.emailtest.smtp.utils.TestMessageHook;
...
public abstract class AbstractSMTPServerTest {
      ...
      String mailContent =
          CharStreams.toString(
              new InputStreamReader(
                  ClassLoader.getSystemResourceAsStream("a50.eml"), StandardCharsets.US_ASCII));
  ...
  private void send(ProtocolServer server, InetSocketAddress bindedAddress, String msg)
  ...
  protected void testMailWithoutBrackets() throws Exception {
    ...
    try {
      ...
      client.mail("invalid");
      assertThat(SMTPReply.isNegativePermanent(client.getReplyCode()))
          .as("Reply=" + client.getReplyString())
          .isTrue();
  ...
  void testHeloHookTempraryError() throws Exception {
    ...
    try {
      ...
      client.helo("localhost");
      assertThat(SMTPReply.isNegativeTransient(client.getReplyCode()))
          .as("Reply=" + client.getReplyString())
          .isTrue();
  ...
  protected static void checkEnvelope(
      MailEnvelope env, String sender, List<String> recipients, String msg) throws IOException {
    ...
    try (BufferedReader reader =
        new BufferedReader(new InputStreamReader(env.getMessageInputStream()))) {
