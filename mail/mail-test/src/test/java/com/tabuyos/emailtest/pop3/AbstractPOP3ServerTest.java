 ...
 * under the License.                                           *
 ****************************************************************/
package com.tabuyos.emailtest.pop3;

import com.tabuyos.emailtest.pop3.utils.MockMailbox;
import com.tabuyos.emailtest.pop3.utils.MockMailbox.Message;
import com.tabuyos.emailtest.pop3.utils.TestPassCmdHandler;
...
public abstract class AbstractPOP3ServerTest {
  ...
  void testTM() {
    ...
    list.forEach(tm -> System.out.println(tm.uid));
  }
}
