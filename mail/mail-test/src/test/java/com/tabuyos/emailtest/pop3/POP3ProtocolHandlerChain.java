...
public class POP3ProtocolHandlerChain extends ProtocolHandlerChainImpl {
  ...
  /**
   * The {@link AbstractPassCmdHandler}'s to use. If at least one {@link AbstractPassCmdHandler} is given, the {@link
   * POP3ProtocolHandlerChain} will add all default handlers
   */
